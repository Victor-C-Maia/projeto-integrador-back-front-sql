...
document
    .getElementById("menu-professores")
    .addEventListener("click", carregarProfessores);

document
    .getElementById("menu-disciplinas")
    .addEventListener("click", carregarDisciplinas);

document
    .getElementById("menu-turmas")
    .addEventListener("click", carregarTurmas);

document
    .getElementById("menu-matriculas")
    .addEventListener("click", carregarMatriculas);

document
    .getElementById("menu-notas")
    .addEventListener("click", carregarNotas);

document
    .getElementById("menu-boletim")
    .addEventListener("click", carregarBoletim);
